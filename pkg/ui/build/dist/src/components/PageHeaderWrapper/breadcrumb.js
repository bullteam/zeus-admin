...
const itemRender = (route, params, routes, paths) => {
    ...
    if (route.path === '/') {
        return React.createElement(Link, { to: paths.join('/') }, route.breadcrumbName);
    }
    return last || !route.component ? (React.createElement("span", null, route.breadcrumbName)) : (React.createElement(Link, { to: paths.join('/') }, route.breadcrumbName));
};
