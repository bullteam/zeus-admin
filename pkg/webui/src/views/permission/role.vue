<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <!--</template>-->
      <!--</el-table-column>-->
      <el-table-column :label="$t('role.actions')" align="center" width="300">
        <template slot-scope="scope">
          <el-button
          ...
          <el-button v-permission="['/permission/role:edit']" type="text" size="mini" @click="handleCopy(scope.row)">
            {{ $t('table.copy') }}
          </el-button>
          <el-button v-permission="['/permission/role:del']" type="text" size="mini" @click="handleDelete(scope.row)">
            {{ $t('table.delete') }}
          </el-button>
        </template>
      </el-table-column>
